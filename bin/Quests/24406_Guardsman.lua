...
if EVENT == 8053 then --¼ö¶ô
   SaveEvent(UID, 8974);
end

if EVENT == 8054 then --°ÅÀý
   SaveEvent(UID, 8977);
end
...
if EVENT == 1003 then --¼ö¶ô
   SaveEvent(UID, 2158);
end

if EVENT == 1004 then --°ÅÀý
   SaveEvent(UID, 2161);
end
...
if EVENT == 8453 then --¼ö¶ô
   SaveEvent(UID, 9034);
end

if EVENT == 8454 then --°ÅÀý
   SaveEvent(UID, 9037);
end
