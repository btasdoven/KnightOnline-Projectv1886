...
class CRebirthUpgradeSet : public OdbcRecordset
{
public:
	CRebirthUpgradeSet(OdbcConnection * dbConnection, RebirthUpgradeArray * pMap) 
		: OdbcRecordset(dbConnection), m_pMap(pMap) {}

	virtual tstring GetTableName() { return _T("REBIRTH_UPGRADE"); }
	...
	virtual bool Fetch()
	{
		_REBIRTH_UPGRADE *pData = new _REBIRTH_UPGRADE;
